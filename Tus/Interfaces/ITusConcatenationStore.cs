...
public interface ITusConcatenationStore
{
    ...
    /// <summary>
    ///     Create a partial file. This method is called when a Upload-Concat header is present and when its value is
    ///     "partial".
    /// </summary>
    ...
    ///     is present with a "final" value. This method must throw a <exception cref="TusStoreException"></exception> if any
    ///     of the provided
